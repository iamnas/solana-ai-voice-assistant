...
# # agent/openai_agent/gpt_agent.py
...
#         prompt = (
#         "You are a Solana voice assistant. Respond briefly in 1-2 sentences. "
#         "If the user wants to end the conversation (e.g., says 'bye', 'stop', etc.), say a short goodbye and also return 'end': true.\n\n"
#         f"User: {text}\n"
#         "Respond in JSON with keys: 'reply' and 'end'"
#         )
...
#                 model=self.model,
#                 messages=[
#                     {"role": "system", "content": "You're a Solana expert voice assistant. Answer briefly (1-2 sentences only)."},
#                     {"role": "user", "content": prompt}
#                 ],
#                 max_tokens=100
#             )
